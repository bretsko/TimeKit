...
//extension TimeKit_Spec {
    ...
    //        let fixedFormat = date.format("MMM dd yyyy", LID.english)
    ...
    //        let r1 = ago5Mins.relString(RelFormatter.defaultStyle, LID.italian)
    //        let r2 = ago5Mins.relString(RelFormatter.twitterStyle, LID.italian)
    ...
    //        let r3 = justNow.relString(RelFormatter.defaultStyle, LID.italian)
    //        expect(r3 == "ora", "Failed to use colloquial formatter")
    //
    //        let justNow2 = Date() - 2.hours
    //        let r4 = justNow2.relString(RelFormatter.twitterStyle, LID.italian)
    //        expect(r4 == "2h fa", "Failed to use colloquial formatter")
    //
    //        let justNow3 = Date() - 1.minutes
    //        let r5 = justNow3.relString(RelFormatter.twitterStyle, LID.english)
    //        expect(r5 == "1 min. ago", "Failed to use colloquial formatter")
    //
    //        let justNow4 = Date() - 51.seconds
    //        let r6 = justNow4.relString(RelFormatter.twitterStyle, LID.english)
...
//expect(result).to(equal(...))
    //        DateRegion.defaultRegion = DateRegion(CalendarID.gregorian, TimeZoneID.europeRome, LID.english)
    //
    //        datesList().forEach {
