...
//                    .to(equal(.june))
            ...
            it("can provide month name for any given locale") {
                ...
                //                expect(Month.january.name(locale: LocaleID.italian).lowercased()).to(equal("gennaio"))
                //
                //                expect(Month.may.name(locale: LocaleID.english).lowercased())
                //                    .to(equal("may"))
                //
                //                expect(Month.may.name(locale: LocaleID.french).lowercased())
                //                    .to(equal("mai"))
            }
