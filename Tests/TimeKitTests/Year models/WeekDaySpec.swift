...
//                    .to(equal(.saturday))
            ...
            it("can provide weekday name for any given locale") {
                ...
                //                expect(WeekDay.monday.name(locale: LID.italian).lowercased())
                //                    .to(equal("lunedì"))
                //                
                //                expect(WeekDay.sunday.name(locale: LID.english).lowercased())
                //                    .to(equal("sunday"))
                //                
                //                expect(WeekDay.monday.name(locale: LID.ukrainian).lowercased()).to(equal("понеділок"))
            }
        }
