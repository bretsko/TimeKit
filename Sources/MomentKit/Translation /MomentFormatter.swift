...
//    fileprivate var cachedTranslations = [ LocaleID : MomentTranslRuleSet ]()
//    
...
//    
//    func getCachedTranslation(for lang: LocaleID) -> MomentTranslRuleSet {
//        
...
//    }
//    
//    func getCachedTranslation(for locale: Locale) -> MomentTranslRuleSet {
