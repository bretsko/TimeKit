...
public class TimeFormatter {
    ...
    fileprivate var cachedTranslations = [ LID : TimeTranslRuleSet ]()
...
public extension TimeFormatter {
    ...
    func string(_ date: Date,
        ...
        //                                        return nil
        //        }
        //        return r.replacingOccurrences(of: "{0}", with: Str(Int(abs(value))))
    }
    
    //TODO: ?
    /// Return all languages supported by the library for relative date formatting
    //    static var allLanguages: Set<LID> {
    //         LID.allCases
    //    }
}
...
fileprivate extension TimeFormatter {
    ...
    func relativeFormat(value: Double,
        ...
        //        }
        //
        //        guard let quantifierRules = unitRules[quantifierKey] as? [Str: Any] else {
        //            return ""
        //        }
        
        //TODO: "other" will not be present when all Str lang data will be replaced with Translation model
        // plural/translations forms
        // "other" rule is supposed to always be present.
        // If only "other" rule is present then "rules" is not an object and is a string.
        //        let quantifier = (lang.quantifyKey(for: abs(value)) ?? .other).rawValue
        //        if let r = quantifierRules[quantifier] as? Str {
        //            return r
        //        }
        
        //TODO :check
        //return quantifierRules[LID.PluralForm.other.s] as? Str ?? ""
    ...
    func suitableTranslation(in styles: [TimeTranslStyle],
                             for lid: LID = .autoUpdating) -> (TimeTranslStyle, [TimeTranslation]) {
        
        let transl = getCachedTranslation(for: lid)
    ...
    // lang?
    func getCachedTranslation(for lang: LID) -> TimeTranslRuleSet {
    ...
    //?
    //    func getCachedTranslation(for locale: LID) -> TimeTranslRuleSet {
    //         getCachedTranslation(for: locale.langID)
    //    }
}

//??
//fileprivate extension LID {
//
//    /// by default uses English
//    var langID: LID {
//
//        let localeId = self.collatorIdentifier ?? LID.english.locale.collatorIdentifier!
//
//        if let langID = LID(rawValue: localeId) {
//            return langID
//        }
//        if let str = localeId.components(separatedBy: "_").first,
//            let fallbackTranslStyles = LID(rawValue: str) {
//            return fallbackTranslStyles
//        }
//        // fallback not found, return English
//        return LID.english.langID
//    }
//}
