...
//        var components = comps([.era, .year, .month, .day], from: date)
//        let dateOne = calendar.date(from: components)
//        
//        components = comps([.era, .year, .month, .day], from: compareDate)
...
//        return Int(self.seconds(since: date)/Constants.SecondsInHour);
//    }
//    
//    /**
...
//        return Int(self.seconds(since: date)/Constants.SecondsInMinute)
//    }
//    
//    /**
...
//        if (calendar == nil) {
//            calendarCopy = Date.defaultCalendar
//        }
//        
//        let earliest = earlierDate(date)
//        let latest = (earliest == self) ? date : self;
//        let multiplier = (earliest == self) ? -1 : 1;
//        let components = calendarCopy!.comps([.year], from: earliest, to: latest)
...
//        let latest = (earliest == self) ? date : self;
//        let multiplier = (earliest == self) ? -1 : 1;
//        let components = calendarCopy!.comps(Constants.AllCalendarUnitFlags, from: earliest, to: latest)
...
//        let latest = (earliest == self) ? date : self;
//        let multiplier = (earliest == self) ? -1 : 1;
//        let components = calendarCopy!.comps([.weekOfYear], from: earliest, to: latest)
...
//        let latest = (earliest == self) ? date : self
//        let multiplier = (earliest == self) ? -1 : 1
//        let components = calendarCopy!.comps([.day], from: earliest, to: latest)
