...
//public extension Date {
     ...
     *
     *  - returns Str - Formatted return string
     */
//    static func timeAgo(since date:Date) -> Str{
...
//    }
     ...
     *  - returns Str - Formatted return string
     */
//    static func shortTimeAgo(since date:Date) -> Str {
...
//    }
     ...
     *  - returns Str - Formatted return string
     */
//    var shortTimeAgoSinceNow: Str {
//        return self.shortTimeAgo(since:Date())
//    }
    
//    func timeAgo(since date:Date,
//                 numericDates: Bool = false,
//                 numericTimes: Bool = false) -> Str {
//
//        let calendar = NSCalendar.current
//        let unitFlags = Set<CalendarComp>([.second,.minute,.hour,.day,.weekOfYear,.month,.year])
...
//
//
//        let components = comps(unitFlags, from: earliest, to: latest)
...
//    func shortTimeAgo(since date:Date) -> Str {
//        let calendar = NSCalendar.current
//        let unitFlags = Set<CalendarComp>([.second,.minute,.hour,.day,.weekOfYear,.month,.year])
//        let earliest = self.earlierDate(date)
...
//    private func logicalLocalizedStringFromFormat(format: Str, value: Int) -> Str{
//        #if os(Linux)
//        let localeFormat = Str.init(format: format, getLocaleFormatUnderscoresWithValue(Double(value)) as! CVarArg)  // this may not work, unclear!!
//        #else
//        let localeFormat = Str.init(format: format, getLocaleFormatUnderscoresWithValue(Double(value)))
//        #endif
//
//        return Str.init(format: DateToolsLocalizedStrings(localeFormat), value)
//    }
    
    
//    private func getLocaleFormatUnderscoresWithValue(_ value: Double) -> Str {
...
//    private func DateToolsLocalizedStrings(_ string: Str) -> Str {
...
//        return Bundle.main.string(forKey: string, value: "", table: "DateTools")
//        #else
...
//        return (self.secondsSince1970 <= date.secondsSince1970) ? self : date
//    }
//
//    /**
...
//    //FIXME: later, see https://forums.swift.org/t/swift-pm-bundles-and-resources/13981/26
