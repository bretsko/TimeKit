...
public extension Date {
    ...
    //          formats: [String] = DateRegion.autoFormats,
    ...
    //    }
    //
    //    enum TimeZoneSimple: String, StrEnumT {
    //        case local, utc
    //    }
    //
    ...
    //
    //            let dateFormat = (isoFormat != nil) ? isoFormat! : ISO8601Format(dateString: str as String)
    //            let df = Date.df(dateFormat.rawValue)
    //            df.locale = Locale(identifier: "en_US_POSIX")
    //            df.timeZone = NSTimeZone.local
    //            df.dateFormat = dateFormat.rawValue
    //            if let a = df.date(from: str as String) {
    ...
    //    /// - Returns: date string.
    //    func dateString(with style: DateFormatter.Style = .medium) -> String {
    ...
    //    func dateTimeString(with style: DateFormatter.Style = .medium) -> String {
    //
    ...
    //    /// - Parameter style: DateFormatter style (default is .medium).
    //    /// - Returns: time string.
    //    func timeString(with style: DateFormatter.Style = .medium) -> String {
    //
    //        Date.df.timeStyle = style
    ...
    //     /// - full: Full day name.
    //     enum DayNameStyle: String, Hashable {
    //         case threeLetters
    //         case oneLetter
    //         case full
    //     }
    ...
    //     enum MonthStyle: String, Hashable {
    //         case threeLetters
    //         case oneLetter
    //         case full
    //     }
    ...
    //    func dayName(with style: DayNameStyle = .full) -> String {
    //
    //        var format: String {
    //            switch style {
    // case .oneLetter:
    ...
    //    func monthName(with style: MonthStyle = .full) -> String {
    //
    //        var format: String {
    //            switch style {
    // case .oneLetter:
    ...
    //        guard let a = df.date(from: String(value)) else { return nil }
    //        self = a
    //    }
}
...
//     - Returns The date df.
//     */
//    static func df(_ format: String = DefaultFormat,
...
//                   _ locale: Locale = Locale.current) -> DateFormatter {
//        var formatters = Date.sharedDateFormatters
