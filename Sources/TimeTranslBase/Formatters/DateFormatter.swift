...
public extension DateFormatter {
    ...
    func format(_ date: Date,
                ...
                zone: TimeZone = Date.defaultTimeZone,
                _ lid: LID? = nil) -> Str? {
        fatalError()
        //        switch mode {
        //        case .iso(let opts):
        ...
        //            return Str(format: "/Date(%.0f%+03d00)/",
        //                          milliseconds,
        //                          tzOffsets)
        //
        //        case .httpHeader:
    ...
    static func shared(format: DateFormat = .standard,
                       ...
                       _ lid: LID = Date.defaultLID) -> DateFormatter {
        shared(format: format.dateFormatString!.s,
               calendar: calendar, lid)
    }
}
