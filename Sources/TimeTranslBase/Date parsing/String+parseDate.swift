...
public extension Str {
    ...
    func parseDate(formats: [Str] = DateFormat.autoFormats,
    ...
    func parseDotNETDate() -> Date? {
        ...
        //            return nil
        //        }
        //        let tz_sign: Str = raw_tz.substring(to: 1)
        //        if tz_sign != "+", tz_sign != "-" {
        //            return nil
        //        }
        //
        //        let tz_hours: Str = raw_tz.substring(with: NSRange(location: 1, length: 2))
        //        let tz_minutes: Str = raw_tz.substring(with: NSRange(location: 3, length: 2))
        //
