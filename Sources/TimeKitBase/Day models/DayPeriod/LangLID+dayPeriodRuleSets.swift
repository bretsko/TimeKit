...
public extension LID {
    ...
    //TODO: consider simplifyig this by removing DayPeriodRule
    var dayPeriodRuleSet: DayPeriodRuleSet? {
        fatalError()
        
        //switch
//        if let ruleSet = _dayPeriodRuleSet {
//            return
...
fileprivate extension CountryLID {
    
    var _dayPeriodRuleSet: [DayPeriod : DayPeriodRule]? {
        fatalError()
    }
}

fileprivate extension LangLID {
